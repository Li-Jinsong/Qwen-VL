...
#     --answers-file /mnt/petrelfs/lijingsong/MLLM/Benchmark/llava-bench-in-the-wild/answers/qwen-665k-lora.jsonl \
#     --temperature 0 \
#     --conv-mode vicuna_v1
...
python llava/eval/eval_gpt_review_bench.py \
    ...
    --answer-list \
        ...
        /mnt/petrelfs/lijingsong/MLLM/Benchmark/llava-bench-in-the-wild/answers/qwen-665k-lora.jsonl \
    --output \
        /mnt/petrelfs/lijingsong/MLLM/Benchmark/llava-bench-in-the-wild/reviews/qwen-665k-lora.jsonl

python llava/eval/summarize_gpt_review.py -f /mnt/petrelfs/lijingsong/MLLM/Benchmark/llava-bench-in-the-wild/reviews/qwen-665k-lora.jsonl
